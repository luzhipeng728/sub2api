...
func setDefaults() {
	...
	viper.SetDefault("gateway.max_account_switches", 40)
	...
	viper.SetDefault("gateway.openai_ws.lb_top_k", 32)
	...
	viper.SetDefault("gateway.scheduling.codex_failover_proven_alive", false)
