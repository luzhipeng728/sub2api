...
func (c opsCleanupDeletedCounts) String() string {
	return fmt.Sprintf(
		"error_logs=%d alert_events=%d system_logs=%d log_audits=%d system_metrics=%d vistara_quota_samples=%d hourly_preagg=%d daily_preagg=%d",
		c.errorLogs,
		c.alertEvents,
		c.systemLogs,
		c.logAudits,
		c.systemMetrics,
		c.vistaraQuotaSamples,
		c.hourlyPreagg,
		c.dailyPreagg,
	)
}
